...
const Fixtures = () => {
  ...
  return (
    <div className="w-full flex flex-col bg-[#171923]">
      {/* Navbar */}
      <div className="w-full h-[12vh] sm:mb-[5rem] sticky top-0">
        <Navbar selected={"Fixtures"} />
      </div>

      {/* Fixtures Section */}
      <div onClick={() => setMenuOpen(false)} className="w-full flex flex-col gap-4 mb-[5rem] items-center text-white font-clash text-lg ">
        {fixtures.map((fixture, index) => (
          ...
          >
            ...
            <div className="flex flex-col w-full md:w-[80%] gap-2 items-center">
              <h2 className="text-xl text-center  sm:text-start w-full ">{fixture.game}</h2>
